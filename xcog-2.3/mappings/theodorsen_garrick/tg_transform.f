...
c non-standard fortran statement
c	  br = br+isign*(t.gt.zero.and.t.lt.one.
c     1           and.s.gt.zero.and.s.lt.one)

          if (t .gt. zero .and. t .lt. one .and. 
     +         s .gt. zero .and. s .lt. one) then
            br = br + isign
          end if
