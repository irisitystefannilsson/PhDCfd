                             ...
                             Partitioning_Type gridDistribution[])
{
  ...
  FileType typ;
  if (xcogFileName.find(".acg") != std::string::npos)
    typ = ASCII;
  else if (xcogFileName.find(".h5") != std::string::npos)
    typ = HDF5;
  else
    throw "xcogFile is apparently neither of ASCII nor of hdf5 type!\n";
...
{
  //  doubleSerialArray XL0 = xM[0].getLocalArray();
  //  doubleSerialArray YL0 = xM[0].getLocalArray();
  //  doubleSerialArray XL1 = xM[1].getLocalArray();
  //  doubleSerialArray YL1 = xM[1].getLocalArray();

//   for (int i=0; i<nr_int_point[1]; i++)
//     {
//       std::cout << i_loc[1](i)*r_stepM[0] << "|-|" << j_loc[1](i)*s_stepM[0] << "|---|" << r_loc[1](i) << "|-|" << s_loc[1](i) << " i_loc,j_loc=" << i_loc[1](i) << "," << j_loc[1](i) << endl;
//     }
//   std::cout << "**********************************" << endl;
//   for (int i=0; i<nr_int_point[0]; i++)
//     {
//       std::cout << i_loc[0](i)*r_stepM[1] << "|-|" << j_loc[0](i)*s_stepM[1] << "|---|" << r_loc[0](i) << "|-|" << s_loc[0](i) << " i_loc,j_loc=" << i_loc[0](i) << "," << j_loc[0](i) << endl;
//     }

// exit(1);
//   for (int i=0; i<nr_int_point[1]; i++)
//     {
//       if (-((i_loc[1](i)-1)*r_stepM[0]-r_loc[1](i)) <0)
// 	{
// 	  std::cout << "Something wrong with interpolation info in grid 1, i_loc" << endl;
// 	  //	  i_loc[1](i)++;
// 	}
//       if(-((j_loc[1](i)-1)*s_stepM[0]-s_loc[1](i)) <0)
// 	{
// 	  std::cout << "Something wrong with interpolation info in grid 1, j_loc" << endl;
// 	  //	  j_loc[1](i)++;
// 	}
//     }
//   for (int i=0; i<nr_int_point[0]; i++)
//     {
//       if (-((i_loc[0](i)-1)*r_stepM[1]-r_loc[0](i)) <0)
// 	{
// 	  std::cout << "Something wrong with interpolation info in grid 0, i_loc" << endl;
// 	  //	  i_loc[0](i)++;
// 	}
//       if (-((j_loc[0](i)-1)*s_stepM[1]-s_loc[0](i)) <0)
// 	{
// 	  std::cout << "Something wrong with interpolation info in grid 0, j_loc" << endl;
// 	  //	  j_loc[0](i)++;
// 	}
//     }
  ...
  for (int k=0; k<nmbrOfGridsM; k++)
	...
	if (nrProcs == 1)
      ...
      //      else
      //	std::cout << i_point[k](i) << " - - -  " << j_point[k](i) << endl;
	...
	for (i=0; i<nr_int_point[currGrid]; i++)
      ...
      //	else
      //	  std::cout << i_loc[currGrid](i)+1 << " + + +  " << j_loc[currGrid](i)+1 << endl;
...
//  std::cout << " myIntPointsM[0].getLength(0) << endl << myIntPointsM[1].getLength(0) << endl " << endl;
//   std::cout << myIntPointsM[0].getLength(0) << endl << myIntPointsM[1].getLength(0) << endl;
//   std::cout << "myNrOfIntPointsM = " << endl;
//   myNrOfIntPointsM.display();
//   std::cout << "nrOfPointsToComputeM = " << endl;
//   nrOfPointsToComputeM.display();
}
